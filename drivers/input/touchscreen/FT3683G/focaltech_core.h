...
#define FTS_DIFF_DATA_LEN (FTS_TX_MAX*FTS_RX_MAX + (FTS_TX_MAX + FTS_RX_MAX)*2 + 11*2)*2
/*
 * start cmd: 0x01
 * touch data : 62 Bytes
 ...
 */
#define FTS_DATA_WITH_DIFF_LEN (FTS_TOUCH_DATA_LEN + FTS_GESTURE_DATA_LEN + FTS_DIFF_COUNT_LEN + FTS_DIFF_DATA_LEN)
